# Memoria tecnica | Eugenio Espejo

## 1. Introduccion
Ficha tecnica automatizada para la administracion zonal Eugenio Espejo.
...
## 5. Area de estudio
Administracion Zonal Eugenio Espejo.
...
- Area ha: sin dato
- Poblacion total: sin dato
- Densidad poblacional: sin dato
- Viviendas: sin dato
- Densidad de vivienda: sin dato

## 10. Criterios de cobertura
- Transporte adecuada %: sin dato
- Transporte parcial %: sin dato
- Transporte deficit %: sin dato
- Equipamientos adecuada %: sin dato
- Equipamientos parcial %: sin dato
- Equipamientos deficit %: sin dato
